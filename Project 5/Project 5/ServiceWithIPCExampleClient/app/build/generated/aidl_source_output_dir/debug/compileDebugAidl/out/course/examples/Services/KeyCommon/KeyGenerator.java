 ...
 * Original file: C:\\Users\\Soham Pradhan\\AndroidStudioProjects\\ServiceWithIPCExampleClient\\app\\src\\main\\aidl\\course\\examples\\Services\\KeyCommon\\KeyGenerator.aidl
 */
...
case TRANSACTION_getEveryKey:
{
data.enforceInterface(descriptor);
java.lang.String[] _result = this.getEveryKey();
reply.writeNoException();
reply.writeStringArray(_result);
return true;
}
case TRANSACTION_getKeyById:
{
data.enforceInterface(descriptor);
int _arg0;
_arg0 = data.readInt();
java.lang.String _result = this.getKeyById(_arg0);
reply.writeNoException();
...
@Override public java.lang.String[] getEveryKey() throws android.os.RemoteException
{
...
mRemote.transact(Stub.TRANSACTION_getEveryKey, _data, _reply, 0);
...
@Override public java.lang.String getKeyById(int pos) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(pos);
mRemote.transact(Stub.TRANSACTION_getKeyById, _data, _reply, 0);
_reply.readException();
...
@Override public java.lang.String[] getUrl() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String[] _result;
...
static final int TRANSACTION_getEveryKey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_getKeyById = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getUrl = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
}
public java.lang.String[] getEveryKey() throws android.os.RemoteException;
public java.lang.String getKeyById(int pos) throws android.os.RemoteException;
