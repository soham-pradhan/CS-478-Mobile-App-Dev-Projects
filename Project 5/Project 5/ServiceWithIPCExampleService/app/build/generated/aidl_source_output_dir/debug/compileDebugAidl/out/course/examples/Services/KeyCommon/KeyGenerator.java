    ...
    private static class Proxy implements course.examples.Services.KeyCommon.KeyGenerator
    {
      ...
      @Override public java.lang.String[] getEveryKey() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getEveryKey, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getEveryKey();
          }
      ...
      @Override public java.lang.String getKeyById(int pos) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(pos);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getKeyById, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getKeyById(pos);
          }
          _reply.readException();
